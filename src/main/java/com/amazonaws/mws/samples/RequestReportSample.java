...
public class RequestReportSample {
    ...
    public static void main(String... args) {
         ...
         * http://aws.amazon.com
         ***********************************************************************/
        final String accessKeyId = "AKIAI6BR4UZSYL6FUINA";
        final String secretAccessKey = "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";

        final String appName = "yks-test";
         ...
         ***********************************************************************/
        final String merchantId = "A1RKKFB6UNM8HV";
        final String sellerDevAuthToken = "amzn.mws.10bad0b9-0373-57ef-e7f2-9d4b7fd21935";
        ...
        RequestReportRequest request = new RequestReportRequest()
		        ...
		        .withReportType("_GET_SELLER_FEEDBACK_DATA_")
		...
		XMLGregorianCalendar startDate = df
				.newXMLGregorianCalendar(new GregorianCalendar(2021, 02, 01,8,0,0));
		request.setStartDate(startDate);
        /*request.setEndDate(df
                .newXMLGregorianCalendar(new GregorianCalendar(2020, 11, 16)));*/
    ...
    public static void invokeRequestReport(MarketplaceWebService service, RequestReportRequest request) {
        try {
            ...
            System.out.println(JSON.toJSON(response.getRequestReportResult().getReportRequestInfo()));
