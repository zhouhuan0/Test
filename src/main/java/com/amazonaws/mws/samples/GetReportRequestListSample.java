...
public class GetReportRequestListSample {
    ...
    public static void main(String... args) {
         ...
         * http://aws.amazon.com
         ***********************************************************************/
        final String accessKeyId = "AKIAJ576LTXHVCMY4BIQ";
        final String secretAccessKey = "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";
         ...
         ***********************************************************************/
        final String merchantId = "A1SOXOM6COI5BC";
        final String sellerDevAuthToken = "amzn.mws.56b6664e-9d5a-4ac7-6c2f-aba3c249141e";

        GetReportRequestListRequest request = new GetReportRequestListRequest();
        request.setMerchant( merchantId );
        request.setMWSAuthToken(sellerDevAuthToken);
        request.setReportRequestIdList(new IdList().withId("74047018615"));
    ...
    public static void invokeGetReportRequestList(MarketplaceWebService service, GetReportRequestListRequest request) {
        try {
            ...
            System.out.println();
            System.out.println(JSON.toJSON(response.getGetReportRequestListResult().getReportRequestInfoList().get(0)));
